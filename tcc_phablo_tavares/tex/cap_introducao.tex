...
O Sistema Integrado de Processos Seletivos (SIPROS) da Universidade Federal de Goiás (UFG) foi concebido para centralizar e padronizar editais de seleção. Contudo, em seu estado prévio ao semestre letivo de 2026/1, o sistema apresentava dívidas técnicas significativas: fluxos simulados (mockados), rotas desconexas, credenciais embutidas diretamente no código-fonte e ausência de uma camada de autenticação robusta.

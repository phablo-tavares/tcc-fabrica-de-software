...
\autor{Nome do Autor do Trabalho} % (José da Silva)
\autorR{Nome Reverso do Autor do Trabalho} % (da Silva, José)

\titulo{Título do Trabalho. Por exemplo:  Estratégia de Testes para o Sistema SimCAQ ou Implementação do Módulo de Inscrições para o Sistema Sipros}
\subtitulo{Relato de Práticas em uma Fábrica de Software}

\cidade{Goiânia} % Nome da cidade em foi desenvolvido o trabalho
\dia{Dia} %
\mes{Mês} % Data da apresentação/defesa do trabalho
\ano{Ano} % Formato numérico: \dia{01}, \mes{01} e \ano{2009}
